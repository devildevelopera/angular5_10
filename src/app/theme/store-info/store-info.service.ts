...
@Injectable()
export class StoreInfoService implements Resolve<any>
{
  ...
  AuthorizeToken: string;
    ...
    getStoreList(): Promise<any>
    {
        ...
        const url=this.getUrl(API_GetStoreListing_URL);
        return new Promise((resolve, reject) => {
                    this.http.get(url,options)
                        .subscribe((response: any) => {
                            resolve(response);
    ...
    SaveStoreInfo(formdata): Promise<any>
    {
        let headers = new  HttpHeaders({
          'Content-Type' : 'application/json',
          'Cache-Control': 'no-cache',
        ...
        const url=this.getUrl(API_GetStoreList_URL);
    ...
    deleteStoreById(arg0: any): Promise<any>
     {
         let headers = new  HttpHeaders({
           'Content-Type' : 'application/json',
           'Cache-Control': 'no-cache',
         ...
         const url=this.getUrl(API_GetStoreList_URL+'/'+arg0);
         return new Promise((resolve, reject) => {
     ...
     GetStoreById(arg0: any): Promise<any>
     {
         let headers = new  HttpHeaders({
           'Content-Type' : 'application/json',
           'Cache-Control': 'no-cache',
...
export const API_GetStoreList_URL = '/api/store-locals';
export const API_GetStoreListing_URL = '/api/all-store-locals';
