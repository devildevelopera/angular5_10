...
@Injectable()
export class CustomerInfoService implements Resolve<any>
{
  ...
  AuthorizeToken: string;
    ...
    getCustomerList(): Promise<any>
    {
        ...
        const url=this.getUrl(API_GetCustomerList_URL);
        return new Promise((resolve, reject) => {
                    this.http.get(url,options)
                        .subscribe((response: any) => {
                            resolve(response);
    ...
    deleteCustomerById(arg0: any): Promise<any>
     {
         let headers = new  HttpHeaders({
           'Content-Type' : 'application/json',
           'Cache-Control': 'no-cache',
         ...
         const url=this.getUrl(API_GetCustomerList_URL+'/'+arg0);
         return new Promise((resolve, reject) => {
     ...
     GetCustomerById(arg0: any): Promise<any>
     {
         let headers = new  HttpHeaders({
           'Content-Type' : 'application/json',
           'Cache-Control': 'no-cache',
...
export const API_GetCustomerList_URL = '/api/customer-infos';
...
export const API_CustomerLike_URL = '/api/customerinfor-like';
